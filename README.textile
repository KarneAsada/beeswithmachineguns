*ATTENTION:* This is a forked version of BMG, forked from the Thrillist fork.  The main modification is that it allows the user of query strings in the target server address.
...
<pre>
git clone git://github.com/KarneAsada/beeswithmachineguns.git
